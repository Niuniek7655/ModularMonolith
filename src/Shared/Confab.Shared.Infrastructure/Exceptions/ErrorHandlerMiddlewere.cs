...
{
    internal class ErrorHandlerMiddlewere : IMiddleware
    {
        ...
        public ErrorHandlerMiddlewere(IExceptionCompositionRoot exceptionCompositionRoot, 
            ILogger<ErrorHandlerMiddlewere> logger)
        {
